...
//       <div
//         className={clsx(
//           'fixed top-0 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ease-out',
//           topStretch > 0 ? 'opacity-60' : 'opacity-10',
//           'flex items-center justify-center'
//         )}
//         style={{ height: `${30 + topStretch}px` }}
//       >
//         <div
//           className={clsx(
//             'rounded-full transition-all duration-300 ease-in-out',
//             'flex items-center justify-center',
//             topStretch >= threshold ? 'bg-red-600 scale-110' : 'bg-green-500 scale-100'
//           )}
//           style={{ transform: `scale(${1 + topStretch / 500})` }}
//         >
...
//       <div
//         className={clsx(
//           'fixed bottom-0 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ease-out',
//           bottomStretch > 0 ? 'opacity-60' : 'opacity-10',
//           'flex items-center justify-center z-200'
//         )}
//         style={{ height: `${30 + bottomStretch}px` }}
//       >
//         <div
//           className={clsx(
//             'rounded-full transition-all duration-300 ease-in-out',
//             'flex items-center justify-center',
//             bottomStretch >= threshold ? 'bg-red-600 scale-110' : 'bg-green-500 scale-100'
//           )}
//           style={{ transform: `scale(${1 + bottomStretch / 500})` }}
//         >
