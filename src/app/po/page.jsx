...
// // Add fulfilled_qty for chart rendering only
...
//                 dataKey="PO_no"
//                 stroke="#737373"
//                 tick={{ fill: "#737373", fontSize: isMobile ? 8 : 20 }}
//               />
//               <YAxis
//               stroke="#737373"
//                 tick={{ fill: "#737373", fontSize: isMobile ? 8 : 20 }}
...
//         {/* PO Data Table */}
//           <h2 className="text-lg text-neutral-500 font-bold text-center">
//             PO Data Table
//           </h2>
//         <div className="overflow-y-scroll w-full h-[250px] ">
//         <StopEvents>
        
//           <table className="min-w-full text-sm text-center rounded-lg overflow-y-scroll">
//            <thead className="bg-gray-100 text-gray-700 sticky top-0 z-20">
//               <tr className="text-[#3699FF]">
//                 <th className="px-1 py-1">PO No</th>
//                 <th className="px-1 py-1">Quantity</th>
//                 <th className="px-1 py-1">Remaining Qty</th>
//               </tr>
//             </thead>
//             <tbody>
...
//                 <tr
//                   key={index}
//                   className="hover:bg-neutral-300 transition-all duration-200"
//                 >
//                   <td className="px-1 py-1">{item.PO_no}</td>
//                   <td className="px-1 py-1">{item.quantity}</td>
//                   <td className="px-1 py-1">{item.remaining_qty}</td>
//                 </tr>
//               ))}
//             </tbody>
...
//                 <td className="px-1 py-1">{totalOrdered}</td>
//                 <td className="px-1 py-1">{totalRemaining}</td>
//               </tr>
//             </tfoot>
//           </table>
//           </StopEvents>
