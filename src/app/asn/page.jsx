...
//               <XAxis dataKey="asn_no" stroke="#737373" />
...
//         <div
//           className="flex flex-col justify-center w-full h-[290px]"
//           style={{
//             overflowY: "scroll",
//             scrollbarWidth: "none",
...
//           <h2 className="text-xl font-semibold text-center text-neutral-500">
...
//                   <th className="px-1 py-1">ASN_no</th>
//                   <th className="px-1 py-1">Total Quantity</th>
//                   <th className="px-1 py-1">Remaining Quantity</th>
//                 </tr>
//               </thead>
//               <tbody>
